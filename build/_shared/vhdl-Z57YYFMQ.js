...
var atoms, hooks, multiLineStrings, keywords, blockKeywords, isOperatorChar, curPunc, vhdl;
var init_vhdl = __esm({
  "../../node_modules/@codemirror/legacy-modes/mode/vhdl.js"() {
    atoms = words("null");
    ...
    blockKeywords = words("architecture,entity,begin,case,port,else,elsif,end,for,function,if");
    isOperatorChar = /[&|~><!\)\(*#%@+\/=?\:;}{,\.\^\-\[\]]/;
    vhdl = {
      name: "vhdl",
...
//# sourceMappingURL=/ERA5_interactive-cookbook/build/_shared/vhdl-Z57YYFMQ.js.map
