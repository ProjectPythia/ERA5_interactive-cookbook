...
var notCharacterOrDash, varNames, keywords, punctuation, wordOperators, symbolOperators, operators, numbers, identifiers, symbolBuiltins, namedBuiltins, variableBuiltins, builtins, grammar, powerShell;
var init_powershell = __esm({
  "../../node_modules/@codemirror/legacy-modes/mode/powershell.js"() {
    notCharacterOrDash = "(?=[^A-Za-z\\d\\-_]|$)";
    varNames = /[\w\-:]/;
    keywords = buildRegexp([
      /begin|break|catch|continue|data|default|do|dynamicparam/,
      /else|elseif|end|exit|filter|finally|for|foreach|from|function|if|in/,
      /param|process|return|switch|throw|trap|try|until|where|while/
    ], { suffix: notCharacterOrDash });
    punctuation = /[\[\]{},;`\\\.]|@[({]/;
    wordOperators = buildRegexp([
      "f",
      /b?not/,
      /[ic]?split/,
      "join",
    ...
    symbolOperators = /[+\-*\/%]=|\+\+|--|\.\.|[+\-*&^%:=!|\/]|<(?!#)|(?!#)>/;
    operators = buildRegexp([wordOperators, symbolOperators], { suffix: "" });
    numbers = /^((0x[\da-f]+)|((\d+\.\d+|\d\.|\.\d+|\d+)(e[\+\-]?\d+)?))[ld]?([kmgtp]b)?/i;
    identifiers = /^[A-Za-z\_][A-Za-z\-\_\d]*\b/;
    ...
    builtins = buildRegexp([symbolBuiltins, namedBuiltins, variableBuiltins], { suffix: notCharacterOrDash });
    grammar = {
      keyword: keywords,
      number: numbers,
      operator: operators,
...
//# sourceMappingURL=/ERA5_interactive-cookbook/build/_shared/powershell-5EQPKYCI.js.map
