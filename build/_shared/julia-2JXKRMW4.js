...
var octChar, hexChar, sChar, uChar, asciiOperatorsList, operators, delimiters, identifiers, chars, openersList, closersList, keywordsList, builtinsList, openers, closers, keywords, builtins, macro, symbol, stringPrefixes, macroOperators, symbolOperators, julia;
var init_julia = __esm({
  "../../node_modules/@codemirror/legacy-modes/mode/julia.js"() {
    ...
    chars = wordRegexp([octChar, hexChar, sChar, uChar], "'");
    openersList = [
      "begin",
      "function",
      "type",
    ...
    openers = wordRegexp(openersList);
    closers = wordRegexp(closersList);
    keywords = wordRegexp(keywordsList);
    builtins = wordRegexp(builtinsList);
    macro = /^@[_A-Za-z\u00A1-\uFFFF][\w\u00A1-\uFFFF]*!*/;
    symbol = /^:[_A-Za-z\u00A1-\uFFFF][\w\u00A1-\uFFFF]*!*/;
    stringPrefixes = /^(`|([_A-Za-z\u00A1-\uFFFF]*"("")?))/;
    macroOperators = wordRegexp(asciiOperatorsList, "", "@");
...
//# sourceMappingURL=/ERA5_interactive-cookbook/build/_shared/julia-2JXKRMW4.js.map
